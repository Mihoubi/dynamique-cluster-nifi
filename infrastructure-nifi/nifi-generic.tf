...
variable  "registry_version"{
  type        = string
  description = "The version of Apache Nifi Registry, e.g. 3.6.1"
}
...
variable "minimum_nifi_registry_count" {
  type        = number
  description = "The minimum number of non-zookeeper NiFi nodes in the Autoscaling Group"
}

variable "maximum_nifi_registry_count" {
  type        = number
  description = "The maximum number of non-zookeeper NiFi nodes in the Autoscaling Group"
}
